...
import { ArrowLeft, Bell, LogOut, Shield, Globe, ChevronRight, Moon, Sun, Check, Wallet, Building2, User, Receipt, HelpCircle, MessageSquare, Star, Gem, History, ArrowUpRight, X, Clock, Smartphone, Watch, Layout, Activity, Heart, Bluetooth, Download, Loader2 } from 'lucide-react';
...
export const Settings: React.FC = () => {
  ...
  const handleActivateWidget = () => {
      ...
      setTimeout(() => {
          ...
          hapticFeedback.success();
          notificationService.showNotification("Widget Added", { body: "Add the SportPulse widget from your home screen." });
      }, 1500);
  };
    ...
    <div className="min-h-full pb-20 relative">
      ...
      <div className="p-6 space-y-8 animate-fade-in">
        ...
        <section>
            ...
            <GlassCard className={`divide-y ${isLight ? 'divide-slate-100' : 'divide-white/5'}`}>
                {user?.isPremium ? (
                    <button className={`w-full p-4 flex items-center justify-between transition text-left ${isLight ? 'hover:bg-slate-50' : 'hover:bg-white/5'}`}>
                        <div className="flex items-center gap-3">
                        ...
                        <span className={`text-[10px] font-bold uppercase tracking-wider ${isLight ? 'text-slate-400' : 'text-white/40'}`}>Manage</span>
                    </button>
                ) : (
                    <button 
                    ...
                    <div className="w-36 h-36 rounded-[24px] bg-gradient-to-br from-indigo-600 to-purple-700 p-4 flex flex-col justify-between shadow-2xl relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-1 mb-1">
                                ...
                                <span className="text-[8px] font-bold uppercase tracking-wider text-white/80">SportPulse</span>
                            </div>
                            ...
                            <div className="flex justify-between items-start">
                                <div>
                                    <div className="flex items-center gap-2 mb-2 opacity-80">
                                        ...
                                        <span className="text-[10px] font-bold uppercase tracking-[0.2em]">SportPulse Pro</span>
                                    </div>
