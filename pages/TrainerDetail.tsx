...
const MOCK_BOOKINGS: Booking[] = [
    { id: 'b1', clientId: 'c1', clientName: 'Jessica M.', clientAvatar: 'https://i.pravatar.cc/150?u=c1', date: '2024-11-15', time: '10:00 AM', status: 'confirmed', price: 60 },
    { id: 'b2', clientId: 'c2', clientName: 'Alex R.', clientAvatar: 'https://i.pravatar.cc/150?u=c2', date: '2024-11-16', time: '02:00 PM', status: 'pending', price: 60 },
];

// Mock Inquiries (Chats)
const MOCK_INQUIRIES = [
    { id: 'c1', senderId: 'c1', senderName: 'Jessica M.', avatar: 'https://i.pravatar.cc/150?u=c1', lastMessage: 'Hi! Do you have availability this weekend?', time: '10m ago', unread: true },
    { id: 'c3', senderId: 'c3', senderName: 'Tom H.', avatar: 'https://i.pravatar.cc/150?u=c3', lastMessage: 'Thanks for the session!', time: '1d ago', unread: false },
];

// Fallback data if navigation state is missing
const MOCK_TRAINERS_DATA: Record<string, User> = {
  't1': {
    id: 't1',
    name: 'Coach David',
    age: 32,
    ...
    availability: { days: ['Mon', 'Wed', 'Fri'], startHour: '08:00', endHour: '18:00' }
  },
};
...
export const TrainerDetail: React.FC = () => {
  ...
  const initialTrainer = (location.state as { trainer: User })?.trainer || (trainerId ? MOCK_TRAINERS_DATA[trainerId] : null);
