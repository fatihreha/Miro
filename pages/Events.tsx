...
const MOCK_EVENTS: SportEvent[] = [
  ...
  },
  {
    ...
    description: 'Amateur doubles tournament. Prizes for winners!',
    attendees: 16,
    attendeeAvatars: ['https://i.pravatar.cc/150?u=10', 'https://i.pravatar.cc/150?u=11'],
    isJoined: false,
    attendanceStatus: 'guest'
  },
  {
    ...
    description: 'High intensity interval training outdoors. Bring water.',
    attendees: 30,
    attendeeAvatars: ['https://i.pravatar.cc/150?u=12', 'https://i.pravatar.cc/150?u=13'],
    isJoined: false,
    attendanceStatus: 'guest'
  }
];
...
export const Events: React.FC = () => {
  ...
  const handleCreateEvent = () => {
      ...
      const createdEvent: SportEvent = {
          ...
          isJoined: true,
          attendanceStatus: 'going' // Creator is always going
      };
